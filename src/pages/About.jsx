  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Software Engineer based in India, specializing in data structures and
          web development.
        </p>
      </div>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            ...
            continuously leveling up my skills and learning from brilliant and
            inspiring individuals. Here's a quick rundown:
          </p>
        </div>
